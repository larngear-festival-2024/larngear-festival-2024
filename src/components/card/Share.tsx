...
export default function Share(props: ShareProps) {
    ...
    return (
        <section className="flex w-full flex-col items-center gap-6">
            <main className="flex w-full flex-col items-center gap-1 rounded-xl border-2 border-white py-4 font-sov text-3xl text-white">
                <section className="flex w-full justify-evenly">
                    <div className="h-48 w-40 rounded-2xl bg-white" />
                    <div className="grid place-items-center">
                        <Image alt={Logo} src={Logo} width={87} height={108} />
            ...
            <div className="sticky grid w-[88vw] place-content-center bg-white p-4">
